        ...
        <Slide triggerOnce>
            <div className="content-con py-5 sm:py-7 md:py-10 lg:py-10 bg-[#d9d0dc]">
                <div className="lg:px-7">
                    <form onSubmit={handleSubmit(onSubmit)} className="bg-white px-3 lg:grid lg:grid-cols-2 lg:gap-x-8 md:px-8 lg:px-12 md:w-1/2 md:mx-auto lg:w-2/3  lg:mx-0 py-6 md:rounded-md">
                        <h2 className="text-xl sm:2xl lg:text-3xl font-bold py-3 sm:py-4 col-span-2">Please Sign Up</h2>
                        {/* Name Input  */}
                        ...
                        <button className="btn  mt-4 bg-gradient-to-r from-purple-600 to-red-500 font-bold text-xl md:text-2xl w-full text-white capitalize lg:col-span-2" type="submit">{loading ? <p className="animate-spin"><FaSpinner></FaSpinner></p> : "Submit"}
                        </button>
                        <div>
